...
class EmbeddingService:
    ...
    def index_metric(
        ...
        try:
            self.qdrant_client.upsert(
                collection_name=settings.QDRANT_COLLECTION,
                points=[PointStruct(id=metric_id, vector=embedding.tolist(), payload=payload)],
            )
    ...
    def is_similar_to_anomaly(
        ...
        """
        similar = self.find_similar_anomalies(device_id, metric_type, value, metadata, limit=1)
