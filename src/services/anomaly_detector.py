...
class AnomalyDetector:
    ...
    def detect_anomaly(self, device_id: str, metric_type: str, value: float,
        ...
        is_similar, similarity_score, similar_anomaly = (
            self.embedding_service.is_similar_to_anomaly(
                device_id, metric_type, value, metadata
            )
        )
    ...
    def _classify_anomaly(self, metric_type: str, value: float, metadata: dict,
                         similarity_score: float, ml_score: float) -> str:
