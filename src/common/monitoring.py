...
metrics_processed_duration = Histogram(
    "device_metrics_processed_duration_seconds", "Time spent processing metrics", ["operation"]
)
...
active_connections = Gauge(
    "device_metrics_active_connections", "Number of active database connections"
)

kafka_messages_produced = Counter(
    "kafka_messages_produced_total", "Total number of Kafka messages produced", ["topic"]
)

kafka_messages_consumed = Counter(
    "kafka_messages_consumed_total", "Total number of Kafka messages consumed", ["topic", "status"]
)
...
class PerformanceMonitor:
    ...
    def record_metric_ingestion(self, device_id: str, metric_type: str):
        ...
        metrics_ingested_total.labels(device_id=device_id, metric_type=metric_type).inc()
    ...
    def record_anomaly(self, device_id: str, classification: str):
        ...
        anomalies_detected_total.labels(device_id=device_id, classification=classification).inc()
